...
export type PhotosSection = {
  id: string;
  title: string;
  /** Optional lead image before the first paragraph */
  image?: PhotosImage;
  paragraphs: PhotosRichPart[][];
  /** Optional second image mid-section (e.g. spiral staircase) */
  imageAfter?: PhotosImage;
  paragraphsAfter?: PhotosRichPart[][];
};
  ...
  sections: [
    {
      ...
      image: {
        ...
        alt: 'Bernini’s colonnade framing St. Peter’s Square',
        width: 1920,
        height: 1275,
        credit: {
    ...
    },
    {
      ...
      image: {
        ...
        alt: 'Gallery of Maps in the Vatican Museums',
        width: 1920,
        height: 1409,
        credit: {
          author: 'Alvesgaspar',
