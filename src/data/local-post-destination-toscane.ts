/**
 * Article local FR + EN : guide complet de la Toscane (page destination).
 */
import { tocFromMarkdown } from '@/lib/markdown';
import type { Post } from '@/data/posts';

export const TOSCANE_FR_SLUG = 'toscane';
export const TOSCANE_EN_SLUG = 'tuscany';
...
Il s'obtient auprès de [CAA-Québec](https://www.caaquebec.com/), avant le départ. La démarche est simple mais elle prend du temps, et le document ne peut pas être obtenu depuis l'Italie.
...
Pour faire le point sur votre situation avant d'engager des frais, [prenez contact](/contact/).
...
It is obtained through [CAA-Québec](https://www.caaquebec.com/), before departure. The process is straightforward but takes time, and the document cannot be obtained once you're in Italy.
...
The full process is described in [getting married in a Catholic church in Italy](/en/getting-married-catholic-church-italy/) and the required documents in [documents for a religious marriage abroad](/en/documents-religious-marriage-abroad/).

To review your situation before committing to any costs, [get in touch](/en/contact/).
  ...
  return {
    ...
    imageAlt:
      opts.lang === 'en'
        ...
        : 'Route bordée de cyprès dans la campagne toscane',
    metaTitle: opts.metaTitle,
    bodyMarkdown,
    faq: opts.faq,
    primaryKeyword:
      opts.lang === 'en' ? 'tuscany travel guide' : 'guide toscane voyage',
    author: {
      ...AUTHOR,
...
const frPost = buildPost({
  ...
  faq: [
    {
      question: 'Y a-t-il un vol direct de Montréal à Florence ?',
      answer:
    ...
    {
      question: 'Faut-il un permis de conduire international en Toscane ?',
      answer:
    ...
    {
      question: 'Combien de jours prévoir en Toscane ?',
      answer:
    ...
    {
      question: 'Quel est le meilleur mois pour aller en Toscane ?',
      answer:
  ...
  relatedSlugs: ['voyage-italie-catholique', 'se-marier-eglise-catholique-italie', 'lune-de-miel-italie'],
});

const enPost = buildPost({
  lang: 'en',
  slug: TOSCANE_EN_SLUG,
  alternateSlug: TOSCANE_FR_SLUG,
  ...
  faq: [
    {
      question: 'Is there a direct flight from Montreal to Florence?',
      answer:
    ...
    {
      question: 'Do you need an international driving permit in Tuscany?',
      answer:
    ...
    {
      question: 'How many days should you plan for Tuscany?',
      answer:
    ...
    {
      question: 'What is the best month to visit Tuscany?',
      answer:
  ...
  relatedSlugs: ['catholic-travel-italy', 'getting-married-catholic-church-italy', 'honeymoon-italy'],
});

export const destinationToscanePosts: Post[] = [frPost, enPost];
