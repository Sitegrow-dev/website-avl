...
Le détail de Saint-Pierre figure dans [la basilique Saint-Pierre](/basilique-saint-pierre/), et l'organisation d'un parcours structuré dans [le pèlerinage à Rome](/pelerinage-rome-italie/).
...
Ce découpage figure dans [l'itinéraire de Rome en 3 jours](/itineraire-rome-3-jours/).
...
Details on St. Peter's are in [St. Peter's Basilica](/en/st-peters-basilica/), and a structured itinerary is in [pilgrimage to Rome](/en/pilgrimage-rome-italy/).
...
This breakdown appears in [the 3-day Rome itinerary](/en/rome-3-day-itinerary/).
...
For the broader context of a stay, see [Catholic travel in Italy](/en/catholic-travel-italy/). For a structured itinerary, [pilgrimage to Rome](/en/pilgrimage-rome-italy/).
`;
...
function buildPost(opts: {
  ...
  return {
    ...
    listingImage: '/images/destinations/rome/churches/santa-maria',
    imageAlt:
      opts.lang === 'en'
        ? 'Interior of a historic Catholic church in Rome'
        : 'Intérieur d’une église catholique historique à Rome',
...
const frPost = buildPost({
  ...
  faq: [
    {
      question: 'Les églises de Rome sont-elles payantes ?',
      answer:
    ...
    {
      question: 'Où voir des Caravage gratuitement à Rome ?',
      answer:
    ...
    {
      question: 'Quelle est la cathédrale de Rome ?',
      answer:
  ...
  relatedSlugs: [
    ...
    'pelerinage-rome-italie',
    'itineraire-rome-3-jours',
  ],
});

const enPost = buildPost({
  lang: 'en',
  slug: PATRIMOINE_ROME_EN_SLUG,
  alternateSlug: PATRIMOINE_ROME_FR_SLUG,
  title: 'Catholic heritage of Rome',
  metaTitle: 'Catholic heritage of Rome: basilicas and sacred art',
  summary:
  ...
  faq: [
    {
      question: 'Are Rome’s churches free to enter?',
      answer:
    ...
    {
      question: 'Where can you see free Caravaggios in Rome?',
      answer:
    ...
    {
      question: 'What is the cathedral of Rome?',
      answer:
    ...
    {
      question: 'Which church to visit if you see only one, besides St. Peter’s?',
      answer:
...
export const patrimoineRomePosts: Post[] = [frPost, enPost];
