/**
 * Article local FR + EN : destination côte amalfitaine.
 */
import { tocFromMarkdown } from '@/lib/markdown';
import type { Post } from '@/data/posts';

export const COTE_AMALFI_FR_SLUG = 'cote-amalfitaine';
export const COTE_AMALFI_EN_SLUG = 'amalfi-coast';
...
**Plus d'une semaine.** Combinez avec Naples, ou avec [Rome](/destinations/rome/) en amont, ce qui est l'itinéraire le plus naturel puisque vous y atterrissez de toute façon.
...
Les démarches figurent dans [se marier à l'église catholique en Italie](/se-marier-eglise-catholique-italie/) et les pièces dans [les documents pour un mariage religieux à l'étranger](/documents-mariage-religieux-etranger/).

Pour faire le point avant d'engager des frais, [prenez contact](/contact/).
...
**More than a week.** Combine with Naples, or with [Rome](/en/destinations/rome/) beforehand — the most natural itinerary, since that is where you land anyway.
...
The procedures are outlined in [getting married in a Catholic church in Italy](/en/getting-married-catholic-church-italy/) and the documents in [documents for a religious marriage abroad](/en/documents-religious-marriage-abroad/).

To review the situation before committing to costs, [get in touch](/en/contact/).
  ...
  return {
    ...
    imageAlt:
      opts.lang === 'en'
        ...
        : 'Village de Positano accroché à la falaise au-dessus de la mer',
    ...
    faq: opts.faq,
    primaryKeyword:
      opts.lang === 'en' ? 'amalfi coast' : 'côte amalfitaine',
    author: {
      ...AUTHOR,
...
const frPost = buildPost({
  lang: 'fr',
  slug: COTE_AMALFI_FR_SLUG,
  alternateSlug: COTE_AMALFI_EN_SLUG,
  ...
  faq: [
    {
      question: 'Comment aller sur la côte amalfitaine depuis Montréal ?',
      answer:
    ...
    {
      question: 'Faut-il louer une voiture sur la côte amalfitaine ?',
      answer:
    ...
    {
      question: 'Quel village choisir sur la côte amalfitaine ?',
      answer:
    ...
    {
      question: 'Quelle est la meilleure période pour la côte amalfitaine ?',
      answer:
...
const enPost = buildPost({
  ...
  faq: [
    {
      question: 'How do you get to the Amalfi Coast from Montreal?',
      answer:
    ...
    {
      question: 'Should you rent a car on the Amalfi Coast?',
      answer:
    ...
    {
      question: 'Which village should you choose on the Amalfi Coast?',
      answer:
    ...
    {
      question: 'What is the best time to visit the Amalfi Coast?',
      answer:
...
export const destinationCoteAmalfitainePosts: Post[] = [frPost, enPost];
