...
Le droit canonique prévoit qu'un mariage entre catholiques est ordinairement célébré dans l'église paroissiale du domicile de l'un des époux. Se marier ailleurs reste possible, mais suppose deux accords distincts, celui du curé de la paroisse de célébration et celui du curé de votre paroisse de domicile, comme le détaille [la procédure canonique du diocèse d'Aix et Arles](https://www.catho-aixarles.fr/wp-content/uploads/sites/28/2023/10/bureau-des-mariages-procedure-canonique-administrative-mariage-maj-2023.pdf). Un mariage en Italie relève exactement de ce cas de figure.
...
Canon law provides that a marriage between Catholics is ordinarily celebrated in the parish church of one of the spouses' domicile. Marrying elsewhere remains possible, but requires two distinct consents: that of the pastor of the celebration parish and that of the pastor of your home parish, as detailed in [the canonical procedure of the Diocese of Aix and Arles](https://www.catho-aixarles.fr/wp-content/uploads/sites/28/2023/10/bureau-des-mariages-procedure-canonique-administrative-mariage-maj-2023.pdf). A marriage in Italy falls exactly into that category.
...
const frPost = buildPost({
  ...
  faq: [
    ...
    {
      question: 'Le dossier de mariage se prépare-t-il en Italie ?',
      answer:
    ...
    {
      question: "Peut-on se marier à l'église si l'un des deux n'est pas baptisé ?",
      answer:
    ...
    {
      question: "Combien de temps avant faut-il s'y prendre ?",
      answer:
...
const enPost = buildPost({
  ...
  faq: [
    {
      question: 'Must you be civilly married before the church ceremony in Italy?',
      answer:
    ...
    {
      question: 'Is the marriage file prepared in Italy?',
      answer:
    ...
    {
      question: 'Can you marry in church if one of you is not baptized?',
      answer:
    ...
    {
      question: 'How far ahead should you start?',
      answer:
