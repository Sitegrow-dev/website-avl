/**
 * Article local FR + EN : documents pour un mariage religieux à l'étranger (Italie).
 */
import { tocFromMarkdown } from '@/lib/markdown';
import type { Post } from '@/data/posts';

export const DOCUMENTS_FR_SLUG = 'documents-mariage-religieux-etranger';
export const DOCUMENTS_EN_SLUG = 'documents-religious-marriage-abroad';
...
- Réserver le lieu de réception avant d'avoir la confirmation de l'église et l'accord sur le calendrier documentaire
...
function buildPost(opts: {
  ...
  return {
    ...
    listingImage: '/images/blog/dossier',
    imageAlt:
      opts.lang === 'en'
        ? 'Passport and administrative documents prepared for a wedding abroad'
        : 'Passeport et documents administratifs préparés pour un mariage à l’étranger',
    ...
    primaryKeyword:
      opts.lang === 'en'
        ? 'documents religious marriage italy'
        : 'documents mariage religieux italie',
    author: {
      ...AUTHOR,
...
const frPost = buildPost({
  ...
  faq: [
    ...
    {
      question: 'Le nulla osta est-il toujours nécessaire pour se marier à l’église en Italie ?',
      answer:
    ...
    {
      question: 'Combien de temps avant la date faut-il commander les documents ?',
      answer:
    ...
    {
      question: 'Faut-il faire traduire et légaliser tous les documents envoyés en Italie ?',
      answer:
  ...
  relatedSlugs: [
    'se-marier-eglise-catholique-italie',
    'cout-mariage-italie',
    'wedding-planner-mariage-italie',
  ],
});

const enPost = buildPost({
  lang: 'en',
  slug: DOCUMENTS_EN_SLUG,
  alternateSlug: DOCUMENTS_FR_SLUG,
  title: 'Documents for a religious marriage abroad',
  metaTitle: 'Documents for a religious marriage abroad in Italy',
  summary:
    'Get the full list of documents for a religious wedding in Italy: banns, nulla osta, certificate of no impediment, and canonical papers by country.',
  bodyMarkdown: enBody,
  category: 'Procedures',
  categorySlug: 'demarches',
  faq: [
    ...
    {
      question: 'Is a nulla osta always required to get married in church in Italy?',
      answer:
    ...
    {
      question: 'How far ahead should you order the documents?',
      answer:
    ...
    {
      question: 'Do all documents sent to Italy need to be translated and legalized?',
      answer:
  ...
  relatedSlugs: [
    'getting-married-catholic-church-italy',
    'cost-wedding-italy',
    'wedding-planner-italy',
  ],
});

export const documentsPosts: Post[] = [frPost, enPost];
